...
public class PerguntaDAO {
	...
	private final static String QUERY_SELECT_ALL= "SELECT * FROM perguntas";
	private final static String QUERY_SELECT_NIVEL= "SELECT * FROM perguntas HHERE nivel = ?";
	...
	public List<Pergunta> listar(String idsPerguntasFeitas, String nivel) {
		String sql = "SELECT * FROM perguntas WHERE nivel = ? ORDER BY RANDOM() LIMIT 2";
